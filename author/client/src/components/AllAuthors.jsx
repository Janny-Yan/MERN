...
import {Link, navigate} from '@reacg/router';
                    ...
                    <tbody>
                        {
                            ...
                            authorList.map((author, index)=>(
                                <tr key={index}>
                                    ...
                                    <td>
                                        <button
                                        style={{backgroundImage:"linear-gradient(pink, purple)", padding:"7px 13px", color:"white",
                                    fontWeight:"bold", margin:"5px", border:"none", borderRadius:"5px"}}
                                        onClick={()=>{navigate(`/edit/${author._id}`)}}>Edit</button>
                                        
                                        <button
                                        style={{
                                            backgroundImage:"linear-gradient(red, orange)", padding:"7px 13px",
